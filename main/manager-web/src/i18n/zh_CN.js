export default {
  ...
  'roleConfig.enableVoice2Voice': '启用Voice2Voice',
  'roleConfig.v2v': '语音对语音(V2V)',
  'roleConfig.voice2voiceMode': 'Voice2Voice模式',
  'roleConfig.voice2voiceDesc': '启用后将使用实时语音对话，绕过ASR、LLM和TTS流程',
